const Facilities = () => {
  return (
    <div class="bg-white dark:bg-gray-900 pt-16 pb-32">
      <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
        <h2 class="text-base font-semibold tracking-wider text-indigo-600 dark:text-indigo-500 uppercase">
          Polling made easy
        </h2>
        ...
        <div class="mt-12">
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div class="pt-6">
              <div class="flow-root bg-gray-100 dark:bg-gray-800 rounded-lg px-6 pb-8">
                <div class="-mt-6">
                  <div>
                    <span class="inline-flex items-center justify-center p-3 bg-indigo-500 dark:bg-indigo-400 rounded-md shadow-lg">
                      <svg
