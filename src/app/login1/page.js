...
const page = () => {
  ...
  return (
    <div className="dark:bg-slate-900 flex lg:h-screen items-center" style={{backgroundImage: 'url(https://i.postimg.cc/sgjS2KpT/logo-vote.jpg)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
      <div className="w-full lg:max-w-[700px] mx-auto lg:p-6 ">
        <div className="py-6 lg:p-9 bg-[#f1faee] border-gray-200 rounded-xl shadow-2xl dark:bg-gray-800 dark:border-gray-700">
